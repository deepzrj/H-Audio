...
class PostBuildScript : IPostprocessBuildWithReport
{
    ...
    public void OnPostprocessBuild(BuildReport report)
    {
        ...
        {
            Debug.Log("LofeltHaptics: adding framework to Embed Frameworks list of project at"
            ...
            const string frameworkFolderXcodeProjectPath = "Lofelt/Plugins/iOS";
            ...
            Debug.Log("LofeltHaptics: Adding framework done!");
